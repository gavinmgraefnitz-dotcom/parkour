...
function animate() {
    ...
    playerBody.velocity.x += (moveDir.x * moveSpeed - playerBody.velocity.x);
    playerBody.velocity.z += (moveDir.z * moveSpeed - playerBody.velocity.z);
